...
function InitFilterDropdown()
    ...
    addHeader("PvP Vendors")
    addFactionRadio("Show All",             "pvpFaction", "all")
    addFactionRadio("|cFF2592C5Alliance|r", "pvpFaction", "Alliance")
    addFactionRadio("|cFFE32A19Horde|r",    "pvpFaction", "Horde")
end
